...
INSERT INTO "pixar_people" ("film","role_type","name")
VALUES
...
('Toy Story','Storywriter','John Lasseter'),
('Toy Story','Storywriter','Joe Ranft'),
('Toy Story','Storywriter','Andrew Stanton'),
('A Bug''s Life','Co-director','Andrew Stanton'),
...
('A Bug''s Life','Storywriter','John Lasseter'),
('A Bug''s Life','Storywriter','Joe Ranft'),
('A Bug''s Life','Storywriter','Andrew Stanton'),
('Toy Story 2','Co-director','Ash Brannon'),
('Toy Story 2','Co-director','Lee Unkrich'),
...
('Toy Story 2','Storywriter','John Lasseter'),
('Toy Story 2','Storywriter','Andrew Stanton'),
('Monsters, Inc.','Co-director','David Silverman'),
('Monsters, Inc.','Co-director','Lee Unkrich'),
...
('Finding Nemo','Storywriter','Andrew Stanton'),
...
('Cars','Storywriter','John Lasseter'),
('Cars','Storywriter','Jorgen Klubien'),
('Cars','Storywriter','Joe Ranft'),
('Ratatouille','Co-director','Jan Pinkava'),
...
('Ratatouille','Storywriter','Brad Bird'),
...
('WALL-E','Storywriter','Andrew Stanton'),
('Up','Co-director','Bob Peterson'),
...
('Up','Storywriter','Pete Docter'),
('Up','Storywriter','Tom McCarthy'),
('Up','Storywriter','Bob Peterson'),
...
('Toy Story 3','Storywriter','Lee Unkrich'),
('Cars 2','Co-director','Brad Lewis'),
...
('Monsters University','Storywriter','Dan Scanlon'),
('Inside Out','Co-director','Ronnie del Carmen'),
...
('Inside Out','Screenwriter','Pete Docter'),
('Inside Out','Screenwriter','Meg LeFauve'),
('Inside Out','Storywriter','del Carmen'),
('Inside Out','Storywriter','Pete Docter'),
('The Good Dinosaur','Director','Peter Sohn'),
('The Good Dinosaur','Musician','Mychael'),
...
('Cars 3','Storywriter','Brian Fee'),
('Cars 3','Storywriter','Eyal Podell'),
('Cars 3','Storywriter','Ben Queen'),
('Cars 3','Storywriter','Jonathan E. Stewart'),
('Coco','Co-director','Adrian Molina'),
...
('Coco','Storywriter','Matthew Aldrich'),
('Coco','Storywriter','Jason Katz'),
('Coco','Storywriter','Adrian Molina'),
('Coco','Storywriter','Lee Unkrich'),
...
('Toy Story 4','Storywriter','Josh Cooley'),
('Toy Story 4','Storywriter','Stephany Folsom'),
...
('Soul','Screenwriter','Pete Docter'),
('Soul','Screenwriter','Mike Jones'),
('Soul','Screenwriter','Kemp Powers'),
('Soul','Storywriter','Pete Docter'),
('Soul','Storywriter','Mike Jones'),
('Soul','Storywriter','Kemp Powers'),
('Luca','Director','Jesse Andrews'),
('Luca','Musician','Jesse Andrews'),
('Luca','Producer','Jesse Andrews'),
('Luca','Screenwriter','Jesse Andrews'),
('Luca','Screenwriter','Jesse Andrews'),
('Luca','Storywriter','Jesse Andrews'),
('Luca','Storywriter','Jesse Andrews'),
('Luca','Storywriter','Jesse Andrews'),
('Turning Red','Director','Domee Shi'),
('Turning Red','Musician','Ludwig Göransson'),
('Turning Red','Producer','Lindsey Collins'),
('Turning Red','Screenwriter','Julia Cho'),
('Turning Red','Screenwriter','Domee Shi'),
('Turning Red','Storywriter','Julia Cho'),
('Turning Red','Storywriter','Domee Shi'),
('Turning Red','Storywriter','Sarah Streicher'),
('Lightyear','Director','Angus MacLane'),
('Lightyear','Musician','Michael Giacchino'),
('Lightyear','Producer','Galyn Susman'),
('Lightyear','Screenwriter','Jason Headley'),
('Lightyear','Screenwriter','Angus MacLane'),
('Lightyear','Storywriter','Matthew Aldrich'),
('Lightyear','Storywriter','Jason Headley'),
('Lightyear','Storywriter','Angus MacLane'),
('Elemental','Director','Peter Sohn'),
('Elemental','Musician','Thomas Newman'),
('Elemental','Producer','Denise Ream'),
('Elemental','Screenwriter','John Hoberg'),
('Elemental','Screenwriter','Brenda Hsueh'),
('Elemental','Screenwriter','Kat Likkel'),
('Elemental','Storywriter','John Hoberg'),
('Elemental','Storywriter','Brenda Hsueh'),
('Elemental','Storywriter','Kat Likkel'),
('Elemental','Storywriter','Peter Sohn'),
('Inside Out 2','Director','Kelsey Mann'),
('Inside Out 2','Musician','Andrea Datzman'),
('Inside Out 2','Producer','Mark Nielsen'),
('Inside Out 2','Screenwriter','Dave Holstein'),
('Inside Out 2','Screenwriter','Meg LeFauve'),
('Inside Out 2','Storywriter','Meg LeFauve'),
('Inside Out 2','Storywriter','Kelsey Mann');
