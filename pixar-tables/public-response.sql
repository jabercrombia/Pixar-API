CREATE TABLE "public_response" (
  "film" text,
  "rotten_tomatoes_score" bigint,
  "rotten_tomatoes_counts" bigint,
  "metacritic_score" bigint,
  "metacritic_counts" bigint,
  "cinema_score" text,
...
('The Incredibles',97,250,90,41,'A+',8,828986),
...
('Toy Story 4',97,459,84,57,'A',7.6,288783),
('Onward',88,350,64,56,'A-',7.4,174917),
('Soul',95,360,83,55,'NA',8,392783),
('Luca',91,303,71,52,'NA',7.4,202404),
('Turning Red',95,289,83,52,'NA',7,158649),
('Lightyear',74,319,60,57,'A-',6.1,127045),
('Elemental',73,262,58,45,'A',7,140174),
('Inside Out 2',90,313,73,59,'A',7.6,168090);
